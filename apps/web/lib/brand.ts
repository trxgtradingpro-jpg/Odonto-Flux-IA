...
export const BRAND_LONG_DESCRIPTION =
  "ClinicFlux AI é uma plataforma SaaS de inteligência artificial para clínicas que querem atender pacientes 24h por dia, qualificar leads automaticamente, agendar consultas e recuperar oportunidades perdidas pelo WhatsApp.";
